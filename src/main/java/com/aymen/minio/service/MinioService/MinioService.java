package com.aymen.minio.service.MinioService;
...
public class MinioService {
    ...
    public List<FileDto> getListObjects() {
        ...
        try {
            Iterable<io.minio.Result<Item>> result = minioClient.listObjects(ListObjectsArgs.builder()
                    .bucket(bucketName)
                    .recursive(true)
                    .build());
            for (io.minio.Result<Item> item : result) {
